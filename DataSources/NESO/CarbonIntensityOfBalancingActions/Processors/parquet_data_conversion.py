...
CSV_DIR = ROOT / "DataSources" / "NESO" / "CarbonIntensityOfBalancingActions"
...
def parse_datetime_smart(series: pd.Series) -> pd.Series:
    """Parse datetimes with dayfirst tuned for the detected format.

    If values are predominantly ISO-like (YYYY-MM-DD...), parse with
    dayfirst=False to avoid pandas warnings and ambiguity.
    """
